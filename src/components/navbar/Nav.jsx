...
export function NavbarDefault() {
  ...
  return (
    <Navbar className="mx-auto max-w-screen-xl px-4 py-2 lg:px-8 lg:py-4 fixed lg:top-5 sm:left-0 sm:top-0 lg:rounded-xl sm:rounded-none lg:left-[350px] w-full">
